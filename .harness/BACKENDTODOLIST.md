...
- [ ] Confirm commits are authored as the correct human contributor or another user-approved human maintainer identity, never Codex or another non-human identity.
- [ ] Coordinate commit scope with frontend work.
